/////////////////////////////////////////////////////////////////////////////
/////////Implementation by Forial Reischl////////////////////////////////////
...
namespace MHApi.Utilities
{
   ...
   public class RingBuffer<T> : IList<T>, ICollection<T>, 
      ...
      /// <returns>The found item at the specified position within the ring buffer.
      /// </returns>
      ...
      public int Count { get; private set; }
       ...
       /// <summary>
       /// Gets the last overall position in the ring-buffer
       /// </summary>
      public int Position
      {
          get
